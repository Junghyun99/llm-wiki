...
- **MDD (최대낙폭):** $\frac{V_{peak} - V_{trough}}{V_{peak}}$, 고점 대비 최대 하락폭
...
- 고점 $82,000, 저점 $61,500 → MDD = $(82000 - 61500) / 82000 = 25\%$
- **칼마비율 = 16.2% / 25% = 0.65**
...
| 지표 | 위험 측정 기준 | 특징 |
|------|--------------|------|
| [[샤프비율_Sharpe_Ratio]] | 전체 표준편차(상·하향 모두) | 가장 범용적 |
| [[소르티노비율_Sortino_Ratio]] | 하방 표준편차만 | 하락 리스크에 집중 |
